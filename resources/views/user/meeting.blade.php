									...
									<div class="jumbotron">
										...
										<div class="mb-2 resoultionRadioWrapper">
											<div class="custom-control custom-radio custom-control-inline">
												<input type="radio" id="resolutionId1_{{ $index }}" name="resolutionRadio_{{ $index }}" class="custom-control-input">
												<label class="custom-control-label pl-4" for="resolutionId1_{{ $index }}">
												For</label>
											</div>
											<div class="custom-control custom-radio custom-control-inline">
												<input type="radio" id="resolutionId2_{{ $index }}" name="resolutionRadio_{{ $index }}" class="custom-control-input">
												<label class="custom-control-label pl-4" for="resolutionId2_{{ $index }}">Against</label>
											</div>
											<div class="custom-control custom-radio custom-control-inline">
												<input type="radio" id="resolutionId3_{{ $index }}" name="resolutionRadio_{{ $index }}" class="custom-control-input">
